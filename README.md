...
## 台灣熱門發文目標論壇 (Target Forums)

系統產出的 `data/posts.csv` 預設為 Discuz! BBCode 格式，特別適合於以下台灣與繁中圈高流量論壇進行免空分享與推廣：

* **伊莉討論區 (EYNY)**：台灣最大綜合下載論壇（高清影視、動漫、遊戲、成人影音）。
* **JKF 捷克論壇**：熱門成人、寫真、影音與綜合免空分享論壇，轉換率極高。
* **5278 論壇 (五月天)**：老牌成人影音論壇，用戶付費與免空下載需求極強。
* **SIS 樂園 (SexInSex)**：全球華人圈最大成人資源論壇之一，包含大量台灣用戶。
* **微風論壇 / 卡提諾論壇**：綜合影音、影視與軟體下載專區。
